    ...
    <div className="p-8 box-border bg-white w-full rounded-sm mt-4 lg:m-7">
      <div className="mb-3">
        ...
        onChange={changeHandler}
          ...
          className="bg-slate-100 outline-none max-w-80 w-full py-3 px-4 rounded-md"
        />
      </div>
      <div className="mb-3">
      ...
      <div className="mb-3 flex items-center gap-x-4">
        ...
        onChange={changeHandler}
          name="category"
          id=""
          className="bg-slate-100 ring-1 ring-slate-900/20 medium-16 rounded-sm outline-none"
        >
      ...
      <div>
        ...
        <input onChange={imageHandler}
          ...
          id="file-input"
          hidden
          className="bg-slate-100 max-w-80 w-full py-3 px-4"
        />
      </div>
