...
const Category = ({ category, banner }) => {
  ...
  return (
    <section className="max_padd_container py-12 xl:py:28">
      <div>
        <div>
          <img src={banner} alt="" className="block my-7 mx-auto mt-20" />
        </div>
        <div className="flexBetween my-8 mx-2">
          <h5>
            <span className="font-bold">Showing 1-12 </span>out of {all_products.filter(item => item.category === category).length} products
          </h5>
